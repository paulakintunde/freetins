---
title: "Evomon Codes: EXP, Evolution Stones and Coins"
slug: "evomon-codes"
permalink: "/blog/evomon-codes/"
category: "Blog"
category_slug: "blog"
focus_keyword: "evomon codes"
secondary_keywords:
  - "evomon rewards"
  - "evomon redeem codes"
  - "evomon code not working"
  - "evomon code expiry"
description: "Evomon codes offer EXP Fruits, capture balls, reroll potions, stones and Coins. Compare each reward and redeem through Settings."
author: "Paul A"
faq:
  - q: "How do I redeem Evomon codes?"
    a: "Join the official experience, complete the introductory setup and open the Settings cog. The reported code box is near the bottom of the panel. Paste the exact string and use OK or the displayed redemption control, then inspect the response and the inventory category for the awarded item."
  - q: "What are EXP Fruits used for?"
...
## Listed Evomon codes and rewards
...
1. Join the official Evomon experience and finish the introductory setup.
2. Open the Settings cog at the top of the screen.
...
EXP Fruits help train a creature already in your team. Capture balls support finding another creature. Before spending either, decide whether your immediate problem is an undertrained teammate or a missing role. Spending every item on the first catch can leave you with fewer choices when your team changes.

Evolution Stones and Omni Stones should not be treated as EXP Fruits. Inspect the creature's evolution requirements before using a material. A code's item list does not establish that every creature accepts the same stone or evolves at the same point.

Reroll potions also have distinct labels. A Trait Reroll Potion, Nature Reroll Potion and Talent Vector Potion are recorded separately because their names refer to different character properties. Read the relevant game control before replacing something you wanted to keep.

## If a reward appears to be missing
...
- [Find codes for another adventure](/codes/)
- [How listed rewards receive editor checks](/how-we-verify/)
- [Roblox avatar gifts and promotions](/blog/roblox-promo-codes/)
